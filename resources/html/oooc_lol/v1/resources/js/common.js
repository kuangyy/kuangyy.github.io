...
function postUrl(url,data){
    ...
    var node = $("#"+id);
    if(node.length<=0){ $("body").append('<div style="display: none;" id="'+id+'">');
        node = $("#"+id);
    }
    node.html(form);
    form.submit();
...
Date.prototype.intervalMonths = function (date){// 时间相差的自然月
    ...
    if(monthTemp>0){
        ...
        if(thisYear<=dateyear){ var year="dateYear-thisYear;" 0-11 2016-05-01~2017-06-01 2016-05-01~2017-05-01 2016-05-01~2017-04-01 month="dateMonth-thisMonth;" if(thisday>dateDay&&dateDay!=dateLastDay){
                month = month-1;
            }
